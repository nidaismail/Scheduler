                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    {{-- <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="{{ url('/viewdata') }}">
                                                    ...
                                                    <div class="content">
                                                        <div class="container text-left">
                                                            <div class="row justify-content-center given-mar">
                                                                <div class="col-lg-10">
                                                                    <form id="filterForm" method="GET" action="{{ url('/viewdata') }}">
                                                                    <div class="row">
                                                                        <div class="col-md-3">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($filteredData as $data)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                            $checked =  $data->admissible==1 ? 'checked="checked"' : '' ?>
...
$(document).ready(function() {
    ...
    $(document).on('change', '.flexSwitchCheckDefault', function() {
        ...
        const admissible = $(this).is(':checked') ? 1 : 0;
        ...
        $.ajax({
            ...
            success: function(response) {
                // Optionally, you can show a success message or handle response
                console.log('Admissible status updated successfully.');
            },
            error: function(xhr, status, error) {
        // Log the error to the console
        console.error('Failed to update admissible status:', error);
        
        // Optionally, display an error message to the user
        alert('Failed to update admissible status. Please try again later.');
            }
        });
    });
});
